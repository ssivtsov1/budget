...
<span class="res-analit1">Всього: </span>2<br><br><br><br><?= GridView::widget([
            'dataProvider' => $dataProvider,'tableOptions' => ['class' => 'table table-striped table-bordered table-condensed'],
            'summary' => false,
            'columns' => [
            ['class' => 'yii\grid\SerialColumn'],
            'type_repair','nakop_s',] ]); ?> </div><?php echo Html::a('Експорт в Excel', ['site/analytics_excel'
            ],
