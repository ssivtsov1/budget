<?php
/**
 * Используется для просмотра бюджета
 */
...
class View_budget extends \yii\db\ActiveRecord
{
    public $nakop;   // Накопительный итог кол-во (РЕМ)
    public $nakop_s; // Накопительный итог стоимость (РЕМ)
    public $nakop_o; // Накопительный итог списано (РЕМ)
    public $nakop_q; // Накопительный итог кол-во получено
    public $nakop_p; // Накопительный итог стоимость выдано
    public $nakop_n; // Накопительный итог кол-во не использовано
    public $nakop_z; // Накопительный итог кол-во не получено
    public $nakop_x; // Накопительный итог стоимость не получено
    public $nakop_v; // Накопительный итог кол-во выдано
    public $nakop_y; // Накопительный итог кол-во не получено
    public $kol;
    public $dname;
