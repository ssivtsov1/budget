...
class InputDataOst extends Model
{
   ...
   // Разделы закупок
    ...
    public function attributeLabels()
    {
        return [
            ...
            'nakop_o' => '',
            'znakop_z' => 'Неотрим план.',
            'nakop_z' => '',
            'znakop_y' => 'Неотрим факт.',
            'nakop_y' => '',
    ...
    {
        return [
            [['id', 'name_service', 'name_tmc','dname','else_repair','else_service','else_spec',
                ...
                'znakop_o', 'nakop_o','znakop_z', 'nakop_z','znakop_n', 'nakop_n',
                'znakop_y', 'nakop_y'], 'safe']
        ];
    }
